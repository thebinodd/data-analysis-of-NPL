...
const Navbar = ({ heading , isHome }: Input) => {
  ...
  return (
    <div>
        ...
        <header className={`flex  lg:max-w-[90vw]   w-[90vw] items-center justify-between rounded-sm  border-neutral-950   ${isHome ? "px-4 py-3 border-b-4" : "px-4 py-1 border-b-2"}  sm:px-6`}>
...

          {
            ...
            <button onClick={()=>router.back()} className="rounded-lg border-2 border-neutral-950 bg-slate-300 px-4 py-2 text-xs font-semibold shadow-[3px_3px_0_0_#111827] transition hover:translate-x-px hover:translate-y-px hover:shadow-none"  >
              ← Back
            </button>
            <button onClick={() => router.push('/')} className="rounded-lg border-2 border-neutral-950 bg-slate-300 px-4 py-2 text-xs font-semibold shadow-[3px_3px_0_0_#111827] transition hover:translate-x-px hover:translate-y-px hover:shadow-none "  >
              Home
            </button>
